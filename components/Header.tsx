...
export default function Header() {
    ...
    const borderBottom:string = "border-b-2 border-gray-200 sm:border-b-0"
  ...
  return (
    <div className='w-screen max-w-6xl h-auto mb-10 flex flex-row justify-center sm:px-5 sm:py-2 sm:mb-6'>
        ...
        <div className={"w-3/4 h-full flex flex-row items-center justify-start space-x-5 py-8 sm:py-0 " + borderBottom}>
            ...
            <ul className='h-full flex flex-row items-center space-x-5 ml-5 sm:hidden'>
                <Link href='/' className={linkBorderBottom}>
                    Collections
                </Link>
                <Link href='/' className={linkBorderBottom}>
                    Men
        ...
        <div className={'w-1/3 h-full flex flex-row space-x-10 justify-end pr-4 sm:pr-0 sm:space-x-4 ' + borderBottom} >
            <Cart />
            <button>
                <Image alt="" src={Avatar} width={50} height={50}  className='rounded-full hover:border-2 border-orange-400'/>
            </button>
        </div>
    </div>
  )
