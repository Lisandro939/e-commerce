...
export default function Cart() {
  ...
  return (
    <div className='flex justify-center items-center z-50'>
        ...
        >   
            <p className='absolute bg-orange-400 text-xs font-black ml-2 mt-[-8px] px-2 rounded-full'>
                {item.numberOfItems}
            </p>
        ...
        { item.title === "" ? 
        <div className={'absolute flex flex-col justify-center items-center px-4 pt-4 inset-y-20 sm:inset-x-0 sm:mx-auto h-[200px] w-[350px] shadow-xl sm:shadow-lg shadow-gray-400 sm:shadow-gray-600 bg-white text-black rounded-lg ' + visibility}>
            <h2>Your cart is empty</h2>
        </div>
        : <div className={'absolute flex flex-col px-4 pt-4 inset-y-20 sm:inset-x-0 sm:mx-auto h-[200px] w-[350px] shadow-xl sm:shadow-lg shadow-gray-400 sm:shadow-gray-600 bg-white text-black rounded-lg ' + visibility}>
